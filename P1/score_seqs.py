def score_seqs(seq1, seq2, match, mismatch, gap):
    ...
    if len(seq1) != len(seq2):
      print("The sequences are not of the same length.")
      return 0
    score = 0
...
print(score_seqs("THEFASTCAT", "THEFATCA-T", 1, -1, -2))
print(score_seqs("THEFA-TCAT", "THEFASTCAT", 1, -1, -2))
print(score_seqs("THEFASTCAT", "THE", 1, -1, -2))
print(score_seqs("THE-FASTCAT", "THE-FASTCAT", 1, -1, -2))
